...
[`urlread`](https://fastcore.fast.ai/net.html#urlread)/[`urljson`](https://fastcore.fast.ai/net.html#urljson)
retrieve a URL (POSTing when `data` or kwargs are given),
[`urlsave`](https://fastcore.fast.ai/net.html#urlsave) downloads to a
file named from the URL, and
[`urlopen`](https://fastcore.fast.ai/net.html#urlopen) wraps `urllib`
with quoting, header, and data handling; on HTTP failure they raise a
status-specific exception (`HTTP404NotFoundError`, …), each a subclass
of
[`HTTP4xxClientError`](https://fastcore.fast.ai/net.html#http4xxclienterror)
or
[`HTTP5xxServerError`](https://fastcore.fast.ai/net.html#http5xxservererror),
with the response body included in the message.
[`start_server`](https://fastcore.fast.ai/net.html#start_server)/[`start_client`](https://fastcore.fast.ai/net.html#start_client)
make TCP — or, passing a string `port`, Unix-socket — connections;
[`waitfor`](https://fastcore.fast.ai/net.html#waitfor) polls a callable
until truthy with a timeout; and
[`is_port_free`](https://fastcore.fast.ai/net.html#is_port_free)/[`wait_port_free`](https://fastcore.fast.ai/net.html#wait_port_free)
help coordinate with servers.
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L50"
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L61"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L69"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L74"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L88"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L114"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L126"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L139"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L175"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L182"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L190"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L201"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L215"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L223"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L228"
target="_blank" style="float:right; font-size:smaller">source</a>
...
[`waitfor`](https://fastcore.fast.ai/net.html#waitfor) polls a callable
until it returns truthy – often needed when coordinating with servers or
other processes that take time to change state. The sync and async
variants share one polling loop
([`_waitfor`](https://fastcore.fast.ai/net.html#_waitfor)), so they
behave identically apart from how they sleep.

------------------------------------------------------------------------

<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L258"
target="_blank" style="float:right; font-size:smaller">source</a>
...
*Async version of
[`waitfor`](https://fastcore.fast.ai/net.html#waitfor)*
...
*Call `f` every 0.1s until it returns truthy, raising `TimeoutError`
with `msg` after `timeout` secs*

A predicate that succeeds on its third call returns normally; one that
never succeeds raises after `timeout` seconds:
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L263"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L275"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L286"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/net.py#L282"
target="_blank" style="float:right; font-size:smaller">source</a>
...
A port held by a
[`start_server`](https://fastcore.fast.ai/net.html#start_server) socket
is busy until the socket closes, at which point
[`wait_port_free`](https://fastcore.fast.ai/net.html#wait_port_free)
returns promptly. Note that
[`start_server`](https://fastcore.fast.ai/net.html#start_server) binds
the hostname’s interface by default, while the port helpers default to
`localhost` – so when combining them, pass an explicit `host` to keep
