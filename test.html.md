...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L18"
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L30"
target="_blank" style="float:right; font-size:smaller">source</a>
...
def expect_fail(
    exc:type=Exception, contains:str=''
):

```

*Context manager that fails unless body raises `exc` optionally
containing `contains`*
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L39"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L45"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L62"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L67"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L78"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L83"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L94"
target="_blank" style="float:right; font-size:smaller">source</a>
...
![](00_test_files/figure-commonmark/cell-37-output-1.png)
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L116"
target="_blank" style="float:right; font-size:smaller">source</a>
...
![](00_test_files/figure-commonmark/cell-40-output-1.png)
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/test.py#L126"
target="_blank" style="float:right; font-size:smaller">source</a>
