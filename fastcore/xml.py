...
# %% auto 0
__all__ = ['voids', 'attrmap', 'valmap', 'FT', 'ft', 'Html', 'Safe', 'to_xml', 'highlight', 'hlmd', 'showtags', 'Head', 'Title',
           'Meta', 'Link', 'Style', 'Body', 'Pre', 'Code', 'Div', 'Span', 'P', 'H1', 'H2', 'H3', 'H4', 'H5', 'H6',
           'Strong', 'Em', 'B', 'I', 'U', 'S', 'Strike', 'Sub', 'Sup', 'Hr', 'Br', 'Img', 'A', 'Nav', 'Ul', 'Ol', 'Li',
...
def hlmd(s, lang='html'):
    "Markdown block with `highlight` result"
    from IPython.display import Markdown
    return Markdown(highlight(s, lang=lang))
