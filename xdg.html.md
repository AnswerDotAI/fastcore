...
[`xdg_data_home`](https://fastcore.fast.ai/xdg.html#xdg_data_home),
...
each return the `Path` given by their `XDG_*` environment variable,
falling back to the
[spec](https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html)’s
default (`~/.cache`, `~/.config`, `~/.local/share`, `~/.local/state`;
`None` for the runtime dir) when it’s unset, empty, or relative.
...
likewise return the colon-split search-path lists.
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/xdg.py#L31"
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/xdg.py#L36"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/xdg.py#L41"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/xdg.py#L46"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/xdg.py#L51"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/xdg.py#L56"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/xdg.py#L62"
target="_blank" style="float:right; font-size:smaller">source</a>
