...
This is what
[`docments`](https://fastcore.fast.ai/docments.html#docments) makes of
that:
...
[`_param`](https://fastcore.fast.ai/funccall.html#_param) extracts a
parameter’s description and default from its
[`docments`](https://fastcore.fast.ai/docments.html#docments)
information. It omits the default when the parameter has none:
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L86"
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L52"
target="_blank" style="float:right; font-size:smaller">source</a>
...
[`handle_type`](https://fastcore.fast.ai/funccall.html#handle_type)
raises `TypeError` for missing annotations, bare `object` and `Any`.
[`union_schema`](https://fastcore.fast.ai/funccall.html#union_schema)
keeps the members it can represent. For example, `str|object` produces a
string schema. A union with no representable members raises an error:
...
A fixed-length tuple such as `tuple[int, str]` becomes an array schema.
`prefixItems` specifies each position’s type. `minItems` and `maxItems`
specify the length.

The schema also includes `items`. It uses the common type when every
position has the same type, or `anyOf` with the distinct types
otherwise.
...
Check unsupported annotations and unions:
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L121"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
def get_schema(
    f:Union[<built-in function callable>, dict], # Function to get schema for
...
[`get_schema`](https://fastcore.fast.ai/funccall.html#get_schema) also
handles more complicated structures such as nested classes. This is
...
### Additional [`get_schema()`](https://fastcore.fast.ai/funccall.html#get_schema) Test Cases
...
Containers support parameterized types such as `List[int]` and raw types
such as `List`:
...
[`mk_ns`](https://fastcore.fast.ai/funccall.html#mk_ns) creates a
dictionary of functions that the LLM can call. Supply the allowed
functions rather than your whole namespace.
[`call_func`](https://fastcore.fast.ai/funccall.html#call_func) uses
this dictionary to resolve a tool name and call it with the supplied
arguments.

------------------------------------------------------------------------

<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L148"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L170"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L189"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L194"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L222"
target="_blank" style="float:right; font-size:smaller">source</a>
...
To use a type that accepts a `str` constructor argument, add it to
`custom_types`.
[`call_func`](https://fastcore.fast.ai/funccall.html#call_func) converts
strings for parameters annotated with that type. Here it constructs
`Path` arguments:
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L234"
target="_blank" style="float:right; font-size:smaller">source</a>
...
Testing async
[`call_func_async`](https://fastcore.fast.ai/funccall.html#call_func_async)
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L249"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L262"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/fastcore/blob/main/fastcore/funccall.py#L270"
target="_blank" style="float:right; font-size:smaller">source</a>
...
[`mk_tool`](https://fastcore.fast.ai/funccall.html#mk_tool) creates a
Python callable from a JSON Schema tool definition. MCP clients can use
it to expose remote tools as functions. The callable has a signature,
annotations and a docstring for introspection and autocomplete.
...
Parameter descriptions use `Annotated` metadata that
[`docments`](https://fastcore.fast.ai/docments.html#docments) can read.
This lets
[`get_schema`](https://fastcore.fast.ai/funccall.html#get_schema)
recover descriptions from an
[`mk_tool`](https://fastcore.fast.ai/funccall.html#mk_tool) callable,
for example when passing an MCP tool to a chat API:
